...
install_nobita() {
    echo ">>> Starting Fresh Install for NotRyxen Hosting..."
    ...
    # --- Step 2: Install Yarn, Dependencies & NotRyxen Hosting Release ---
    npm i -g yarn
    cd /var/www/pterodactyl
    yarn
    sudo apt install -y zip unzip git curl wget

    echo ">>> Downloading latest NotRyxen Hosting release..."
    ...
    # --- Step 3: Run NotRyxen Hosting Installer ---
...
reinstall_nobita() {
    echo ">>> Starting Reinstall for NotRyxen Hosting..."
    blueprint -rerun-install
}

# Function: Update NotRyxen Hosting
update_nobita() {
    echo ">>> Starting Update for NotRyxen Hosting..."
    blueprint -upgrade
...
while true; do
    ...
    echo "3) Update NotRyxen Hosting"
    echo "0) Exit"
    echo "============================"

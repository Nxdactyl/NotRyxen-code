...
install_nobita() {
    echo ">>> Starting Fresh Install for NyroxDevelop & Nobita Hosting..."
    ...
    # --- Step 2: Install Yarn, Dependencies & NyroxDevelop & Nobita Hosting Release ---
    npm i -g yarn
    ...
    # --- Step 3: Run NyroxDevelop Hosting Installer ---
...
reinstall_nobita() {
    echo ">>> Starting Reinstall for NyroxDevelop Hosting..."
    blueprint -rerun-install
}

# Function: Update NyroxDevelop Hosting
update_nobita() {
    echo ">>> Starting Update for NyroxDevelop Hosting..."
    blueprint -upgrade
...
while true; do
    ...
    echo "3) Update NyroxDevelop Hosting"
    echo "0) Exit"
    echo "============================"

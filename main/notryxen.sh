...
blueprint_theme_menu() {
    while true; do
        ...
        case $subchoice in
            1)
                run_remote_script "https://raw.githubusercontent.com/Nxdactyl/NotRyxen-code/refs/heads/main/cd/Blueprint2.sh"
                ;;
            2)
                print_header_rule
                big_header "WELCOME"
...
while true; do
    ...
    case $choice in
        1) run_remote_script "https://raw.githubusercontent.com/Nxdactyl/NotRyxen-code/refs/heads/main/cd/panel2.sh" ;;
        2) run_remote_script "https://raw.githubusercontent.com/Nxdactyl/NotRyxen-code/refs/heads/main/cd/wing2.sh" ;;
        3) run_remote_script "https://raw.githubusercontent.com/Nxdactyl/NotRyxen-code/refs/heads/main/cd/uninstall2.sh" ;;
        4) blueprint_theme_menu ;;
        5) run_remote_script "https://raw.githubusercontent.com/Nxdactyl/NotRyxen-code/refs/heads/main/cd/cloudflare.sh" ;;
        6) system_info ;;
...
MYSQL_SCRIPT
            ...
            ;;
        0)
            echo -e "${GREEN}Exiting NotRyxen Hosting Manager...${NC}"
            print_header_rule

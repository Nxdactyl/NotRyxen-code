...
EOF
    echo -e "           ${WHITE}NOTRYXEN PREMIUM PTERODACTYL INSTALLER${NC}"
    echo -e "${HEADER_LINE}"
}
...
# --- DATA COLLECTION ---
ask "Panel Domain" "panel.notryxen.indevs.in" DOMAIN
...
sed -i 's|MAIL_FROM_NAME=.*|MAIL_FROM_NAME="Not Ryxen"|g' .env
